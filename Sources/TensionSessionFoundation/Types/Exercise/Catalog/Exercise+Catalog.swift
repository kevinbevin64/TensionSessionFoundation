    ...
    public final class Catalog {
        ...
        init() {
            self.all = [
                ...
                // Kind("Bicep Curl", isBuiltIn: true),
                ...
                // Kind("Close-Grip Bench Press", isBuiltIn: true),
                ...
                // Kind("Reverse Fly", isBuiltIn: true),
                // Kind("Reverse Lunge", isBuiltIn: true),
                // Kind("Rowing", isBuiltIn: true),
                // Kind("Russian Twist", isBuiltIn: true),
                // Kind("Seated Calf Raise", isBuiltIn: true),
                // Kind("Seated Leg Curl", isBuiltIn: true),
                // Kind("Seated Row", isBuiltIn: true),
                // Kind("Shoulder Press", isBuiltIn: true),
                ...
                // Kind("Standing Calf Raise", isBuiltIn: true),
                // Kind("Step-Up", isBuiltIn: true),
                // Kind("Stiff-Leg Deadlift", isBuiltIn: true),
                // Kind("T-Bar Row", isBuiltIn: true),
                // Kind("Thruster", isBuiltIn: true),
                // Kind("Tricep Extension", isBuiltIn: true),
                // Kind("Tricep Kickback", isBuiltIn: true),
                // Kind("Tricep Pushdown", isBuiltIn: true),
